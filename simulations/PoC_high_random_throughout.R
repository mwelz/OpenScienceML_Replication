...
num_scales <- 30L   # number of scales
...
# interval from which to draw correlations
interval_W  <- c(0.6, 0.8)  # within-scale correlation interval
...
results_list <- parallel::mclapply(
  ...
  FUN = function(r) {
    ...
    data_uncontam_list <- generate_data_interval(
      n = n,
